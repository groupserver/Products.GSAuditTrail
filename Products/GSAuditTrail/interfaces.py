...
class IAuditEvent(Interface):
    ...
    '''
    id = TextLine(title='Event ID',  # FIXME: ID
      description='The ID of the event',
      required=True)

    date = Datetime(title='Date',
        description='The date and time of the event.',
        required=True,
        default=datetime.now(UTC))

    subsystem = TextLine(title='Subsystem',
      description='The ID of the subsystem that generated the event',
      required=True)

    code = TextLine(title='Event Code',
      description='A code that specifies the type of event. This is subsystem '
                  'specific.',
      required=True)

    userInfo = Field(title='User Information',
      description='Information about the actor initiating the event. This may '
                  'be null if it is the system acting.',
      required=False)

    instanceUserInfo = Field(title='Instance User Information',
      description=' user being *acted upon*. This may be null if the user '
    ...
    instanceDatum = Text(title='Instance Datum',
      description='Data that may be required to assist in distinguishing this '
                  'specific instance of the event. For example, the email '
                  'address being sent a verification_request',
      required=False)

    supplementaryDatum = Text(title='Instance Datum',
      description='Data related to the event, that may prove useful as part '
                  'of the log. For example, the actual bounce email in the '
                  'event of a bounce, or a message entered by the '
                  'administrator explaining a user ban.',
      required=False)

    xhtml = TextLine(title='XHTML',
